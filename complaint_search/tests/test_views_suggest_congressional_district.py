...
class SuggestCongressionalDistrictTests(APITestCase):
    def setUp(self):
        pass
    ...
    def test_suggest_no_param(self, mock_essuggest):
        ...
        """
        url = reverse("complaint_search:suggest_congressional_district")
    ...
    def test_suggest_text__valid(self, mock_essuggest):
        ...
        """
        url = reverse("complaint_search:suggest_congressional_district")
        param = {"text": "maryland", "congressional_district": "maryland congressional district 1"}
